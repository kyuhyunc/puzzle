#############################################################################
# Makefile for building: puzzle_kyuhyunc.app/Contents/MacOS/puzzle_kyuhyunc
# Generated by qmake (2.01a) (Qt 4.8.6) on: Fri Jan 30 01:55:07 2015
# Project:  puzzle_kyuhyunc.pro
# Template: app
# Command: /usr/local/bin/qmake -o Makefile puzzle_kyuhyunc.pro
#############################################################################
...
DIST          = /usr/local/Cellar/qt/4.8.5/mkspecs/common/unix.conf \
		...
		puzzle_kyuhyunc.pro
QMAKE_TARGET  = puzzle_kyuhyunc
DESTDIR       = 
TARGET        = puzzle_kyuhyunc.app/Contents/MacOS/puzzle_kyuhyunc
...
all: Makefile puzzle_kyuhyunc.app/Contents/PkgInfo puzzle_kyuhyunc.app/Contents/Resources/empty.lproj puzzle_kyuhyunc.app/Contents/Info.plist $(TARGET)

$(TARGET):  $(OBJECTS)  
	@$(CHK_DIR_EXISTS) puzzle_kyuhyunc.app/Contents/MacOS/ || $(MKDIR) puzzle_kyuhyunc.app/Contents/MacOS/ 
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: puzzle_kyuhyunc.pro  /usr/local/Cellar/qt/4.8.5/mkspecs/unsupported/macx-clang-libc++/qmake.conf /usr/local/Cellar/qt/4.8.5/mkspecs/common/unix.conf \
		/usr/local/Cellar/qt/4.8.5/mkspecs/common/mac.conf \
		/usr/local/Cellar/qt/4.8.5/mkspecs/common/gcc-base.conf \
		/usr/local/Cellar/qt/4.8.5/mkspecs/common/gcc-base-macx.conf \
		/usr/local/Cellar/qt/4.8.5/mkspecs/common/clang.conf \
	...
	$(QMAKE) -o Makefile puzzle_kyuhyunc.pro
...
puzzle_kyuhyunc.app/Contents/PkgInfo: 
	@$(CHK_DIR_EXISTS) puzzle_kyuhyunc.app/Contents || $(MKDIR) puzzle_kyuhyunc.app/Contents 
	@$(DEL_FILE) puzzle_kyuhyunc.app/Contents/PkgInfo
	@echo "APPL????" >puzzle_kyuhyunc.app/Contents/PkgInfo
puzzle_kyuhyunc.app/Contents/Resources/empty.lproj: 
	@$(CHK_DIR_EXISTS) puzzle_kyuhyunc.app/Contents/Resources || $(MKDIR) puzzle_kyuhyunc.app/Contents/Resources 
	@touch puzzle_kyuhyunc.app/Contents/Resources/empty.lproj
	
puzzle_kyuhyunc.app/Contents/Info.plist: 
	@$(CHK_DIR_EXISTS) puzzle_kyuhyunc.app/Contents || $(MKDIR) puzzle_kyuhyunc.app/Contents 
	@$(DEL_FILE) puzzle_kyuhyunc.app/Contents/Info.plist
	@sed -e "s,@SHORT_VERSION@,1.0,g" -e "s,@TYPEINFO@,????,g" -e "s,@ICON@,,g" -e "s,@EXECUTABLE@,puzzle_kyuhyunc,g" -e "s,@TYPEINFO@,????,g" /usr/local/Cellar/qt/4.8.5/mkspecs/unsupported/macx-clang-libc++/Info.plist.app >puzzle_kyuhyunc.app/Contents/Info.plist
dist: 
	@$(CHK_DIR_EXISTS) .tmp/puzzle_kyuhyunc1.0.0 || $(MKDIR) .tmp/puzzle_kyuhyunc1.0.0 
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/puzzle_kyuhyunc1.0.0/ && $(COPY_FILE) --parents board.h guitile.h mainwindow.h mylist.h pmminlist.h puzzle_heur.h puzzle_move.h puzzle_solver.h .tmp/puzzle_kyuhyunc1.0.0/ && $(COPY_FILE) --parents board.cpp guitile.cpp mainwindow.cpp pmminlist.cpp puzzle_heur.cpp puzzle_move.cpp puzzle_solver.cpp qtpuzzle.cpp .tmp/puzzle_kyuhyunc1.0.0/ && (cd `dirname .tmp/puzzle_kyuhyunc1.0.0` && $(TAR) puzzle_kyuhyunc1.0.0.tar puzzle_kyuhyunc1.0.0 && $(COMPRESS) puzzle_kyuhyunc1.0.0.tar) && $(MOVE) `dirname .tmp/puzzle_kyuhyunc1.0.0`/puzzle_kyuhyunc1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/puzzle_kyuhyunc1.0.0
...
distclean: clean
	-$(DEL_FILE) -r puzzle_kyuhyunc.app
	-$(DEL_FILE) Makefile
...
compiler_moc_header_make_all: moc_guitile.cpp moc_mainwindow.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_guitile.cpp moc_mainwindow.cpp
moc_guitile.cpp: guitile.h
	/usr/local/Cellar/qt/4.8.5/bin/moc $(DEFINES) $(INCPATH) -D__APPLE__ -D__GNUC__ guitile.h -o moc_guitile.cpp
